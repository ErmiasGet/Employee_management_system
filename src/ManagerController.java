...
public class ManagerController {
    ...
    void onBackHandler(ActionEvent event) throws IOException {
            Parent root = (Parent) FXMLLoader.load(getClass().getResource("MainLoginView.fxml"));
    ...
    void onLoginHandler(ActionEvent event) throws Exception {
        try {
            resultSet = con.createStatement().executeQuery("select * from manager where Username = '" +
